...
class AuthenticationController(
    ...
    fun signUp(@Valid @RequestBody request: SignUpRequest): ApiResponse {
        ...
        return ApiResponse(payload = userDto)
    }
    ...
    fun refresh(@Valid @RequestBody request: RefreshTokenRequest): ApiResponse {
    ...
    fun signOut(@Valid @RequestBody request: RefreshTokenRequest, sRequest: HttpServletRequest): ApiResponse {
        ...
        return ApiResponse(message = translateService.toLocale(MessageKey.SIGN_OUT_SUCCESS))
    }
